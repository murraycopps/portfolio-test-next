            ...
            <div className="px-4 py-6 bg-gray-900">
                <div className="relative w-full h-64 overflow-auto">
                    ...
                    <p className="w-full text-lg font-medium text-center text-gray-400 indent-8">
                        I made a desktop and mobile friendly website using next.js that you can demo
                        <Link href="https://pacing-website-next.vercel.app/" target="_blank" className="font-bold text-blue-500"> here.</Link>
                    </p>
                </div>
                ...
                <div className="w-full px-4 py-6 bg-gray-900 sm:w-1/3">
                    ...
                    <div className="mx-auto mt-6 phone-aspect-ratio">
                        <Link href="https://pacing-app.murraycopps.repl.co/" target="_blank">
                            <img src="/images/html-app.PNG" alt="HTML Model" className="object-cover w-full h-full" />
                        </Link>
                    </div>

    ...
    return (
        <PageWrapper title="Balsa Crane">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
                <Image src="/images/crane-front.jpeg" alt="Balsa crane in action" className="w-full h-64 sm:h-96 object-cover rounded-lg" />
                <Image src="/images/crane-side.jpeg" alt="Balsa crane design" className="w-full h-64 sm:h-96 object-cover rounded-lg" />
            </div>
            <div className="grid grid-cols-1 grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 gap-4 mt-4">
                <Link href="/files/crane-drawing.pdf" target="_blank">
                    <Image src="/images/crane-drawing-image.png" alt="Balsa crane in action" className=" w-full lg:w-auto object-cover rounded-lg mx-auto" />
                </Link>
